...
// api key
const APIKey = "50c510e61a114afbb1115811c4a4032f";
...
const App = () => {
  ...
  // set the icon accordion to the weather
  let icon;
  ...
  return (
    <div className="w-full h-screen bg-gradientBg bg-no-repeat bg-cover bg-center flex flex-col items-center justify-center px-4 lg:px-0 ">
      {errorMsg && (
        <div className="w-full max-w-[90vw] lg:max-w-[450px] bg-[#ff208c] text-white absolute top-2 lg:top-10 p-4 rounded-md z-30">{`${errorMsg.response.data.message}`}</div>
      )}
      {/* form */}
      <form
        className={`${
          ...
          <div>
            ...
            <div className="my-20">
              <div className="flex justify-center items-center">
                {/* temp */}
                <div className="text-[133px] leading-none font-light">
